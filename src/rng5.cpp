...
*
* File: rcg5.cpp
* Description: Modify the program so it has 5 copies of the random number function running concurrently in different threads. 
...
*   08 Oct 2017		1.40		JH		Launch 5 instances 
*
********************************************************************/
...
int main()
{
    ...
    pthread_create(&gen1, NULL, rngTask, (void*) queue);
    pthread_create(&gen2, NULL, rngTask, (void*) queue);
    pthread_create(&gen3, NULL, rngTask, (void*) queue);
    pthread_create(&gen4, NULL, rngTask, (void*) queue);
    pthread_create(&gen5, NULL, rngTask, (void*) queue);
